  ...
  return (
    <Tabs screenOptions={{
      ...
      tabBarInactiveTintColor:'#3333',
        ...
        />
        <Tabs.Screen name='lines' options={{headerShown:false,title:'Lines',
          tabBarIcon:({color}) => <Ionicons name="home" size={24} color={color} />}}
        />
        <Tabs.Screen name='dailyTrips' options={{headerShown:false,title:'Daily Trips',
          tabBarIcon:({color}) => <FontAwesome5 name="user-alt" size={22  } color={color}/>}}
        />
        <Tabs.Screen name='addData' options={{headerShown:false,title:'Add Data',
